...
TEST_SRC = training_corpus/testing_training_corpus/training-corpus-testing.cpp training_corpus/database.cpp testing/utils-testing.cpp testing/test-all.cpp text_utils.cpp
